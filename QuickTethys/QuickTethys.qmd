...
format:
  pdf:
    output-file: "tethys_in_a_hurry_1.2"
    output-ext:  "pdf"
    pdf-engine: xelatex
    mainfont: Verdana
    margin-left: 1.25in
...
Press the **Export** button to start the Deployment Export dialog. Again, you'll be asked for several pages of information about what you were doing and why (@fig-deploywiz). The information you need can mostly be copied from the project website at [https://compass-oceanscience.eu/](hhttps://compass-oceanscience.eu/).
