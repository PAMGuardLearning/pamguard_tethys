...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomtitle=1mm, bottomrule=.15mm, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Quicker unzipping}, coltitle=black, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, breakable, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomtitle=1mm, bottomrule=.15mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Species Codes}, coltitle=black, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, breakable, toprule=.15mm]
